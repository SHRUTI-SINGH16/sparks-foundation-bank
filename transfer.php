                    ...
                    <tbody>
                        ...
                        ?>
                            <tr style="text-align: center; color : #ff3333;color:white">
                                ...
                                <td><a href="transfer-funds.php?id= <?php echo $row['id']; ?>"> <button type="button" class="btn" style="border:none;color:yellow;	background:brown; transition: 1s;">Tranfer</button></a></td>
                            </tr>
                        <?php
                        }
                        ?>
